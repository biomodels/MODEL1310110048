# MODEL1310110048: MODEL1310110048
...
`pip install git+https://github.com/biomodels/MODEL1310110048.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110048.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110048 as model`
...
The model of esophagus squamous epithelial cells metabolism is derived from
...
and identified by:
[MODEL1310110048](http://identifiers.org/biomodels.db/MODEL1310110048) .
